<template>
  <div class="container">
    ...
    <v-form v-if="showForm" @submit.prevent="isEditMode ? updateProduct() : postAddProduct()">
      ...
      <v-dialog width="400" v-model="showBuyDialog">
        <v-card>
          ...
          <v-card-subtitle><br>
            ...
            รายละเอียด : {{ selectedProduct.detail }}
          ...
          <v-card-actions>
            <v-btn color="primary" style="color:white" @click="saveOrder">BUY</v-btn>
            ...
            <v-row>
              ...
              <v-col cols="4" class="text-end">
                <v-card-text>
                  ...
                  <v-btn width="150" text class="red" color="white accent-4" @click="postAddOrder(item._id)"><v-icon size="20">mdi-cart-outline</v-icon>&nbsp;<b>BUY</b></v-btn>
                </v-card-text>
              </v-col>
            </v-row>
          </v-card-text>
